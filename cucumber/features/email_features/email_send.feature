Feature: the server receives a request to send an email
  ...
  Scenario Outline: send custom HTML template batch Email to identity objects
    ...
    Examples:
      ...
      | 01f0000000000000003f0001 | /api/notification/email | email/valid_template.json   | email/batch/valid_custom_template_email.json   | email/valid_email_response.json            |
      | 01f0000000000000003f0002 | /api/notification/email | email/invalid_template.json | email/batch/invalid_custom_template_email.json | email/invalid_template_email_response.json |
  ...
  Scenario Outline: send custom HTML template email to a single email address
    ...
    Examples:
      | identity_id              | endpoint                      | template                           | email                                                  | response                                   |
      | 01f0000000000000003f0001 | /api/notification/singleEmail | email/valid_template.json   | email/single/valid_single_custom_template_email.json   | email/valid_email_response.json            |
      | 01f0000000000000003f0002 | /api/notification/singleEmail | email/invalid_template.json | email/single/invalid_single_custom_template_email.json | email/invalid_template_email_response.json |
