Feature: the server receives a request to send a gcm push notification
  ...
  Scenario Outline: send gcm push notification to an identity objects
    ...
    Examples:
      ...
      | 01f0000000000000003f0001 | /api/push/gcm  | gcm/valid_gcm.json        | gcm/valid_gcm_response.json     |
      | 01f0000000000000003f0001 | /api/push/gcm  | gcm/invalid_gcm.json      | gcm/invalid_gcm_response.json   |