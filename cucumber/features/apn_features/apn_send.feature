Feature: the server receives a request to send an apn push notification
  ...
  Scenario Outline: send apn push notification to an identity objects
    ...
    Examples:
      ...
      | 01f0000000000000003f0001 | /api/push/apn  | apn/valid_apn.json        | apn/valid_apn_response.json     |
      | 01f0000000000000003f0001 | /api/push/apn  | apn/invalid_apn.json      | apn/invalid_apn_response.json   |